...
export default [
  ...
  {
    path: '/program/details/:uuid', // Specify the route path with the `uuid` parameter
    name: 'programDetails',
    component: './Program/Detail',
    hideInMenu: true,
  },
  {
    path: '/program/version/edit/:programUuid/:versionUuid', // Specify the route path with the `uuid` parameter
    name: 'versoinEdit',
