import {
  ...
  getAllPrograms,
  updateProgram,
} from '@/services/updater-server/api'; // Import your API methods
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical">
        ...
        <Form.Item name="windowsInstallPath" label="Windows安装路径">
          <Input />
        </Form.Item>
        <Form.Item name="linuxInstallPath" label="Linux安装路径">
          <Input />
        </Form.Item>
      </Form>
    </Modal>
...
const ProgramManagementPage = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    await deleteProgram({ uuid: deleteProgramUuid })
      .then((response) => {
  ...
  const handleCreate = async (values) => {
    ...
    const programData = {
      ...
      windowsInstallPath: values.windowsInstallPath,
      linuxInstallPath: values.linuxInstallPath,
    };
  ...
  return (
    ...
    >
      ...
      <Modal title="Update Program" visible={visible} onCancel={handleCancel} footer={null}>
        <Form
          form={form}
        ...
        >
          ...
          <Form.Item name="windowsInstallPath" label="windows Install Path">
            <Input />
          </Form.Item>
          <Form.Item name="linuxInstallPath" label="linux Install Path">
            <Input />
          </Form.Item>
