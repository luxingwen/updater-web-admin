...
export async function deleteProgram(uuid: string, options?: { [key: string]: any }) {
  return request<Record<string, any>>(`/api/v1/program/delete/${uuid}`, {
    method: 'POST',
    ...(options || {}),
  });
}
...
export async function deleteVersion(uuid: string, options?: { [key: string]: any }) {
  return request<Record<string, any>>(`/api/v1/program/version/delete/${uuid}`, {
    method: 'POST',
    ...(options || {}),
  });
}
...
export async function getPackageList(
  ...
  return request<API.Package[]>(`/api/v1/package/list`, {
    method: 'POST',
    data: {
      ...body,
    },
...
export async function createPackage(body: API.Package, options?: { [key: string]: any }) {
  return request<API.Package>(`/api/v1/package/create`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updatePackage(body: API.Package, options?: { [key: string]: any }) {
  return request<API.Package>(`/api/v1/package/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deletePackage(uuid: string, options?: { [key: string]: any }) {
  return request<Record<string, any>>(`/api/v1/package/delete/${uuid}`, {
    method: 'POST',
    ...(options || {}),
  });
}
